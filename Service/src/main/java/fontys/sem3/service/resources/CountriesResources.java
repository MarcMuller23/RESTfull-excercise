...
public class CountriesResources {
    ...
    @GET //GET at http://localhost:XXXX/countries/hello
    @Path("/hello")
    ...
    @GET //GET at http://localhost:XXXX/countries/3
    @Path("{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getCountriesPath(@PathParam("id") String countryCode) {
    ...
    @GET //GET at http://localhost:XXXX/countries?
    @Produces(MediaType.APPLICATION_JSON)
    public Response getAllCountries(@QueryParam("country") String countryCode) {
